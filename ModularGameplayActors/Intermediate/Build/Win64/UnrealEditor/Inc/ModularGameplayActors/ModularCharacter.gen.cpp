...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AModularCharacter()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AModularCharacter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AModularCharacter, 3448807505);
	template<> MODULARGAMEPLAYACTORS_API UClass* StaticClass<AModularCharacter>()
	{
		return AModularCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AModularCharacter(Z_Construct_UClass_AModularCharacter, &AModularCharacter::StaticClass, TEXT("/Script/ModularGameplayActors"), TEXT("AModularCharacter"), false, nullptr, nullptr, nullptr);
